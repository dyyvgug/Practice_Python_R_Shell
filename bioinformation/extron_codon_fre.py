...
in_file = open('40_hE_hT_seq.fa','r')
out_file = open('40_hE_hT_codon_fre.txt','w')
...
TPM_value_file = open('SRR1804340_abund.out','r')
TPM_value = ''
for line in TPM_value_file:
    TPM_value = TPM_value + line.strip()

tRNA_demand = open('40_hE_hT_tRNA_dem.txt','w')
